...
const config = {
  title: 'TODO',        // Your website title
  url: 'TODO.me',          // Your website URL
  project: 'TODO',      // Firebase project. See README.md -> How to Deploy
  trackingID: 'CHANGE_ME',                 // Google Analytics Site's ID
};
...
tasks.set('publish', () => {
  ...
  return run('build').then(() => new Promise((resolve, reject) => {
    ...
    const uploader = client.uploadDir({
      localDir: 'public',
      deleteRemoved: true,
      s3Params: { Bucket: 'voop.tv', ACL: 'public-read' },
    });
